...
from course2_lane2 import Course2_lane2
...
class Autonomous_Drive(State):
    ...
    def execute(self, userdata):
        ...
        while True:
            ...
            line_follower.autonomous_drive(True, 0.4)
        ...
        while True:
            ...
            if self.flag == 0:
                ...
                if self.change_time + 1.0 > time.time():
                    ...
                    self.move.set_angle(-0.2) # lane 1 -0.2
                    rospy.loginfo('turn!')
    ...
    def execute(self, userdata):
        ...
        while True:
            ...
            if self.flag == 0:
                ...
                if self.change_time + 1.0 > time.time():
                    self.move.set_velocity(0)
                    self.move.set_angle(0.0) # lane 1 0.25
                    rospy.loginfo('turn!')
                    self.move.go_forward()
    ...
    def execute(self, userdata):
        ...
        while True:
            ...
            if self.flag == 0:
                ...
                if self.change_time + 2.4 > time.time():
