...
class DetectRightToLeft:
    ...
    def image_callback(self, msg):
        ...
        if stop_line_toggle == True:
            self.robot_controller.set_angle(0)
        ...
        # print('counters_bumfer = >>>> ', contours_bumper)
        ...
        if self.state == 1 and len(contours_bumper) > 1:
            print('>>>>', self.state)
            self.state += 1
